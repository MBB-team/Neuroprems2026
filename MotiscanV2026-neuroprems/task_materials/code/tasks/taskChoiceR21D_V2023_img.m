function [sub_data] = taskChoiceR21D_V2023_img(sub_data,cfg)
% function [sub_data] = taskChoiceR21D_V2023_img(sub_data, cfg)
%
...
%-----------------------------------------------
taskName = 'ChoiceR21D'
taskChoice_strctName = 'taskChoiceR21D'
...
while iTrial < nTraining
    ...
    img.l = imgTrainingR2(training_options(1,iTrial)).texture;
    ...
    img.r = imgTrainingR2(training_options(2,iTrial)).texture;
...
while iTrial<nTrial
    ...
    img.l = imgItemR2(list(1,iTrial)).texture;
    img.r = imgItemR2(list(2,iTrial)).texture;

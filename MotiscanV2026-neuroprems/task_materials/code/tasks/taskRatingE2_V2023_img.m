function [sub_data] = taskRatingE2_V2023_img(sub_data, cfg)
% function [sub_data] = taskRatingE2_V2023_img(sub_data, cfg)
%
% taskRatingE2 - execute effort rating task (from motiscan battery V2)
% Launch the task with this function for testing one subject.
% The subject has to provide a subjective estimate of effort item.
%
%   task specifications:

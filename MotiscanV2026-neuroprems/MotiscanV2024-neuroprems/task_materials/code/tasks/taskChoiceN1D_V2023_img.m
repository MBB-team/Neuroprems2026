function [sub_data] = taskChoiceN1D_V2023_img(sub_data,cfg)
% function [sub_data] = taskChoiceN1D_V2023_img(sub_data, cfg)
%
...
%-----------------------------------------------
taskName = 'ChoiceN1D';
taskChoice_strctName = 'taskChoiceN1D';
...
pairingList_file  = 'appariementN-2024.xlsx';
appariement_testing = readtable(pairingList_file);
instruc_fill      = 'COMPORTEMENTS EN SOCIETE présentés';

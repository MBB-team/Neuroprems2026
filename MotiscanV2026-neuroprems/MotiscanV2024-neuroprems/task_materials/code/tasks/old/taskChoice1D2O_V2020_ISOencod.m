function [sub_data] = taskChoice1D2O_V2020(sub_data,cfg,dimension)
...
switch dimension
    case 'E'
        ...
        pairingList_file  = 'appariementE.xlsx';
    case 'P'
    ...
    case 'R'
        ...
        pairingList_file  = 'appariementR.xlsx';
end
...
while iTrial < nTraining
    ...
    DrawMyText(display.window,text.quePref,ftsz_small,[100 100 100],[x,y*1/2],max_charPline);

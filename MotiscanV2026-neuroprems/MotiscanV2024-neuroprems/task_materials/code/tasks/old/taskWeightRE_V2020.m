function [sub_data] = taskWeightRE_V2020(sub_data, cfg)
% function [sub_data] = taskWeightRE_V2020(sub_data, cfg)
%
...
%% New fixed pairing
index = readtable('appariementRE.xlsx');
...
data          = table((1:nTrial)',stimR,ratingBenefit,stimE,ratingCost,isLeftChoice',choice_position',choicedo',rt','VariableNames',varNames);
